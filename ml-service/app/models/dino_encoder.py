...
class DINOv2Encoder(BaseModel):
    """DINOv2 model for image embedding extraction."""

    # DINOv2 normalization parameters (ImageNet stats)
    ...
    def preprocess(self, image: np.ndarray) -> np.ndarray:
        ...
        # Apply DINOv2 normalization (mean and std)
        normalized = (normalized - self.DINO_MEAN) / self.DINO_STD
